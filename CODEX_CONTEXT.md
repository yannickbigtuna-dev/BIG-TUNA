...
Brightspace discovery is browser-bot based, not Brightspace API based. `BRIGHTSPACE_URL` can point at the Brightspace landing/home page; the bot discovers class/course links, then looks for assignment/dropbox/submission/activity pages in each class. Site-specific selector overrides are available because Brightspace markup varies by school.
